...
$test_packager->addIdentifier('https://www.dropbox.com/s/vgvc634rv6bdi3r/focalinux1-pdf.zip');
//$test_packager->addFile($test_file, $test_mimetype);
$test_packager->setHasPart('https://www.dropbox.com/s/vgvc634rv6bdi3r/focalinux1-pdf.zip');
