<?php
	...
	$testurl = "http://repositorio.poa.ifrs.edu.br:8080/sword/servicedocument";
	
	// The user (if required)
	$testuser = "jonathan.videira@gmail.com";
	
	// The password of the user (if required)
	$testpw = "cpdjonathan";
	
	// The on-behalf-of user (if required)
	$testobo = "jonathan.videira@gmail.com";

	// The URL of the example deposit collection
	$testdepositurl = "http://repositorio.poa.ifrs.edu.br:8080/sword/deposit/11014/3";

	// The test file to deposit
	$testfile = "test-files/mets_swap_package.zip";
